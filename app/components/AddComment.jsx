...
export default function AddComment({ handleChangeComment, description, addComment }) {
	return (
		<form className="comment" action="/">
			<h2>Tell us whet do you think about this movie</h2>
			<textarea placeholder="Movie description" value={description} onChange={handleChangeComment}></textarea>
